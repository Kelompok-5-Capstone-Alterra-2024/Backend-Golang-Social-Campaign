...
func NewFundraisingHandler(fundraisingService service.FundraisingService) *FundraisingHandler {
	return &FundraisingHandler{fundraisingService}
}
...
func (h *FundraisingHandler) GetFundraisingByID(c echo.Context) error {
	...
	response := dto.ToFundraisingResponse(fundraising)
...
func (h *FundraisingHandler) GetFundraisingsByCategoryID(c echo.Context) error {
	...
	fundraisings, err := h.fundraisingService.FindFundraisingByCategoryID(id)
